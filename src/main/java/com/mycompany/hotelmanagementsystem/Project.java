...
//package project;
import Beans.DoubleRoom;
import Beans.Food;
import Beans.SingleRoom;
import Exception.NotAvailable;
import java.io.File;
...
class Hotel {
    ...
    static void printFeatures(int i) {
        switch (i) {
            case 1:
    ...
    static void checkAvailability(int i) {
        int j, count = 0;
        switch (i) {
            case 1:
                for (j = 0; j < 10; j++) {
    ...
    static void deallocateRoom(int rn, int rtype) {
        int j;
        char w;
        switch (rtype) {
            case 1:
                if (ob.arr1[rn] != null) {
                    System.out.println("Room used by " + ob.arr1[rn].getName());
                } else {
            ...
            case 2:
                if (ob.arr2[rn] != null) {
                    System.out.println("Room used by " + ob.arr2[rn].getName());
                } else {
                    System.out.println("Empty Already");
                    return;
                }
            ...
            case 3:
                if (ob.arr3[rn] != null) {
                    System.out.println("Room used by " + ob.arr3[rn].getName());
                } else {
                    System.out.println("Empty Already");
                    return;
                }
            ...
            case 4:
                if (ob.arr4[rn] != null) {
                    System.out.println("Room used by " + ob.arr4[rn].getName());
                } else {
                    System.out.println("Empty Already");
                    return;
                }
            ...
            do {
                ...
                switch (ch) {
                    case 1:
                        ...
                        ch2 = sc.nextInt();
                        Hotel.printFeatures(ch2);
                        break;
                    case 2:
                        System.out.println("\nChoose room type :\n1.Luxury Double Room \n2.Deluxe Double Room \n3.Luxury Single Room\n4.Deluxe Single Room\n");
                        ch2 = sc.nextInt();
                        Hotel.checkAvailability(ch2);
                        break;
                    case 3:
                        System.out.println("\nChoose room type :\n1.Luxury Double Room \n2.Deluxe Double Room \n3.Luxury Single Room\n4.Deluxe Single Room\n");
                        ch2 = sc.nextInt();
                    ...
                    case 4:
                        ...
                        if (ch2 > 60) {
                            ...
                            Hotel.orderFood(ch2 - 41, 4);
                        } else if (ch2 > 30) {
                            Hotel.orderFood(ch2 - 31, 3);
                        } else if (ch2 > 10) {
                            Hotel.orderFood(ch2 - 11, 2);
                        } else if (ch2 > 0) {
                            Hotel.orderFood(ch2 - 1, 1);
                        } else {
                            System.out.println("Room doesn't exist");
                        }
                        break;
